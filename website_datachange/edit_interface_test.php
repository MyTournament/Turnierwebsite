...
//DEAKTIVIERT WEIL AKTUELL NICHT GENUTZT: $insert_id = myDb_execute($conn, $TurnierID, $bn, "edit_interface_test.php",$sql, array($name, $description, $fk_random));
...
//DEAKTIVIERT WEIL AKTUELL NICHT GENUTZT: $insert_id = myDb_execute($conn, $TurnierID, $bn, "edit_interface_test.php 2",$sql, array("4", "3"));
echo "_UPDATE: $insert_id <br/>"; //gibt es nur bei Insert
$sqlType = substr($sql, 0, 6);
echo "SQL-Type: $sqlType<br/>";

$sql = "DELETE FROM edit_interface_test WHERE fk_random = ?";
//DEAKTIVIERT WEIL AKTUELL NICHT GENUTZT: $insert_id = myDb_execute($conn, $TurnierID, $bn, "edit_interface_test.php 3",$sql, array("4"));
