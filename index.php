...
//BULLEREI KOMMT
// Fallback-Initialisierungen fÃ¼r lokale Umgebung
...
<html>
    <head>
        ...
        <meta name="description" content="Berlins grÃ¶ÃŸtes Bierball-Turnier">
    ...
    <div class="content">
        <div class="inner">
            ...
            if($turnier_phase_ID == 1){
                ...
                echo "<p><i>Hinweis: Der Anmeldezeitraum ist leider schon beendet. Es gibt aber eine Warteliste. Du kannst dein Team also trotzdem noch anmelden, wir kÃ¶nnen nur nicht versprechen dass wir noch KapazitÃ¤t haben.</i></p>";
...
<article id="teams">
    ...
    if($loggedInValue){
        ...
        echo "<div style='color:white; text-align: center;'>";
            ...
            echo "<p>Aus DatenschutzgrÃ¼nden sind die Personendaten mit einem Passwort geschÃ¼tzt.</p>";
...
<article id="history">
    ...
    <p>WÃ¤hle ein Turnier aus der folgenden Liste aus oder klicke unten auf die alte Website.</p>
...
<article id="history_info">
    <div style='background-color:#7700FF;'>
        <div style='color:white; text-align: center;'>
            ...
            <!--Alle Informationen, die Teams und Spiele betreffen, wurden vom gewÃ¼nschten Turnier geladen. 
...
<article id="kontakt">
    ...
    <p>Falls du Dinge hast, die du uns gerne mitteilen mÃ¶chtest oder zum Beispiel dein Team wieder abmelden wollen solltest, ist hier der perfekte Ort dafÃ¼r. Falls du dein Team abmelden mÃ¶chtest, schreib bitte dein Teampasswort dazu.</p>
...
<title>Backstage-Login</title>
    ...
    <h2>Testmodus</h2>
    <p>Der Testmodus ist dafÃ¼r da, alle Funktionen der Website auszuprobieren. Der Testmous lÃ¤uft mit einem Test-Turnier mit ausgedachten Teams.</p>
    ...
    <a href="#pausenraum">ðŸ“ Pausenraum</a>
...
<article id="vielendankfuerdeineanmeldung">
    <div style='text-align: center'>  
        ...
        <h1>Vielen Dank fÃ¼r deine Anmeldung!</h1>
        ...
        ?>
            <input type="text" id="benutzercheck" name="bn" class="Eingabe" placeholder="Dein Team-KÃ¼rzel" style="color: white" required>
        ...
        <?php
            ...
            if($teilnahmebeitrag == 1){
                echo "
                    <h3><a href=$link_solibeitrag>ðŸ’“TeilnahmebeitragðŸ’“</a></h3>
                    <p><b>Nicht vergessen, die 10â‚¬ TeilnahmegebÃ¼hr pro Team per Paypal an kummerkasten@REDACTED.de zu bezahlen! (Verwendungszweck: Euer Teamname)</b> Das Geld stecken wir zu 100% ins Turnier, beispielsweise in die Preise, die Website, Sticker und der Rest flieÃŸt in Bier fÃ¼rs Turnier.</p>                  
...
<article id="vielendankfuerdeineanmeldung_warteliste">
    <div style='text-align: center'>  
        ...
        <h3>Vielen Dank fÃ¼r deine Anmeldung!</h3>
        <h3>Leider ist die maximale Teamanzahl schon erreicht! Deswegen wurde dein Team einer Warteliste hinzugefÃ¼gt und kann dann nachrÃ¼cken, wenn sich andere Teams wieder abmelden. Informiert euch am besten ab und zu mal auf der Website, ob ihr eventuell noch nachgerÃ¼ckt seid.</a></h3>
        </br>
...
<article id="logincheck_success">
    <div style='text-align: center'>  
        ...
        <?php 
            ...
            /*echo"<h3><a href=$link_solibeitrag>ðŸ’“UnterstÃ¼tze unsðŸ’“</a></h3>";
            echo"
            <p>Gerne kannst du uns mit einem Solibeitrag unterstÃ¼tzen. Das Geld stecken wir zu 100% ins Turnier, beispielsweise in die Preise, die Website und das Grillevent am letzten Tag.</p>                  
...
<article id="edit_games_success">
    <h1>Danke fÃ¼r deinen Eintrag!</h1>
...
<article id="edit_games_failure">
    ...
    <p>Vielleicht war dein Passwort falsch, vielleicht hast du nicht die nÃ¶tigen Rechte. Vielleicht hat Hermann auch einen Fehler gemacht. Falls du Fragen oder Probleme hast, wende dich an kummerkasten@REDACTED.de!</p>
    <a class="button" href='#spielplan'>Zum Spielplan</a>
    <p></br></p> <!-- AbstÃ¤nde unten damit Button auf Handys nicht von Cookiewarnung Ã¼berdeckt wird -->
    <p></br></p>
</article>		
...
if($schnee==1){
    ...
    src='/assets/js/cookieinfo.min.js' data-linkmsg='Zeig mir diese Cookies &#9733;' data-moreinfo='javascript:start()' data-onclick='javascript:start()' data-expires='1min Wartezeit bis die Cookies gelÃ¶scht werden. Zu verÃ¤ndern in der .js Datei'>
    </script>";
}
?>
