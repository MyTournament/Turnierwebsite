...
class Spiel{
    ...
    function create(){
        ...
        myDb_execute($this->MySQLiconn, $TurnierID, $this->who_inserted_or_updated_last, "spiel.php", $sql, array($this->fk_begegnung, $this->biereheimteam, $this->biereauswaertsteam, $this->who_inserted_or_updated_last));
    ...
    function update(){
        ...
        myDb_execute($this->MySQLiconn, $TurnierID, $this->who_inserted_or_updated_last, "spiel.php 2", $sql, array($this->fk_begegnung, $this->biereheimteam, $this->biereauswaertsteam, $this->who_inserted_or_updated_last, $this->id));
